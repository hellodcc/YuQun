...
#import "AHeader.h"
#import "UIView+MJ.h"
@implementation Baozhengjinshuoming{
    NSArray * infoArr;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel * contextLab =[[UILabel alloc]initWithFrame:CGRectMake(10, titleLab.frame.size.height + 20, SCREEN_SIZE.width - 80, contextSize.height)];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return titleSize.height + contextSize.height + 40;
