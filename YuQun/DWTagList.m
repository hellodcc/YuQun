...
#define BACKGROUND_COLOR [UIColor colorWithRed:44/255.0 green:100/255.0 blue:162/255.0 alpha:1]
#define TEXT_COLOR [UIColor whiteColor]
#define TEXT_SHADOW_COLOR [UIColor whiteColor]
#define TEXT_SHADOW_OFFSET CGSizeMake(0.0f, 0.0f)
#define BORDER_COLOR [UIColor colorWithRed:44/255.0 green:100/255.0 blue:162/255.0 alpha:1]
#define BORDER_WIDTH 1.0f
#define HIGHLIGHTED_BACKGROUND_COLOR [UIColor colorWithRed:1.00 green:1.00 blue:1.00 alpha:0.5]
...
- (void)display
{
    ...
    {
        id text=[textArray objectAtIndex:i];
        DWTagView *tagView;
        if (tagViews.count > 0) {
        ...
        {
            [tagView setBackgroundColor:COLOR_BACK];
            [tagView setTextColor:[UIColor grayColor]];
            [tagView setBorderColor:[UIColor grayColor].CGColor];
        }else
        {
